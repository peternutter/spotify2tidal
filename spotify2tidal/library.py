...
def export_podcasts(podcasts: List[dict], export_dir: Path, filename: str = "spotify_podcasts.csv"):
    """
    ...
    with open(filepath, "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
        writer.writerow([
            "spotify_id", "name", "publisher", "description", "total_episodes", 
            "spotify_url", "exported_at"
        ])
        ...
        for item in podcasts:
            ...
            description = (show.get("description", "") or "")[:200]  # Truncate long descriptions
...
def export_tidal_tracks(tracks: list, export_dir: Path, filename: str = "tidal_tracks.csv"):
    """
    ...
    with open(filepath, "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
        writer.writerow([
            "tidal_id", "name", "artists", "album", "duration_seconds", "isrc", "exported_at"
        ])
...
def export_tidal_albums(albums: list, export_dir: Path, filename: str = "tidal_albums.csv"):
    """
...
def export_tidal_artists(artists: list, export_dir: Path, filename: str = "tidal_artists.csv"):
    """
